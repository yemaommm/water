...
.p_bottom{width: 530px;height: 65px;position: absolute;top:220px;left: 60%;}
		...
		<div class="p_con">
			<div class="p_content">
				<div class="p_top" id="p_top">
					<a href="javascript:getSecond();" id="p_corp"
						class="p_corp_1">自来水公司分布图</a><a href="javascript:location.href='aa.jsp';"
						id="p_star" class="p_corp_2">上海行政区分布图</a>
				</div>
				<div class="p_bottom">
					<a href="report.jsp?corpId=" id="toReport" class="p_corp">水质报表</a>
					<a href="chartAllArea.jsp?corpAll=1" id="toChart" class="p_corp">水质趋势图</a>
				</div>
				<div class="p_left">
				</div>
				<div class="p_right">
	...
	function getMap(){
	$(".p_left").empty();
       	$(".p_left").append("<img src='site_media/img/corp.jpg' width='980' height='840' border='0' usemap='#Map' style='z-index:0;'/><map name='Map' id='Map'>"
	...
	function getForErea(){
				var content="<table width='550' border='0' cellspacing='0' cellpadding='1'><tr><td class='line005'><table width='100%' border='0' cellspacing='0' cellpadding='0'><tr> <td height='50' colspan='6' background='site_media/img/005.jpg'><table width='100%' border='0' cellpadding='0' cellspacing='0' class='f20px'> <tr><td width='50' align='center'><img src='site_media/img/009.png' alt='' width='11' height='11' /></td> <td>水质主要参数总体均值</td> <td width='100' align='center'></td></tr> </table></td><td background='site_media/img/005.jpg' height='50' colspan='6'></td></tr>";
	...
	$(".p_left").empty();
       	$(".p_left").append("&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src='site_media/img/corp.jpg'	width='512'  height='615' border='0' usemap='#Map' style='z-index:0;'/>"
